...
YUI.add("lha-repo", function(Y) {
    ...
    /**
     * Wraps a supplied callback method in error handling code in order to prevent client 
     * implemented code from breaking things.
     * 
     * @cb { Function } Client supplied callback. If no function is supplied (or the supplied
     *  	object is not a function, this will generate a dummy method. 
     */
    ...
    LHARepository.ATTRS = {
    	...
    	baseUri : {
    		value : 'http://localhost:8080/LHA/data',
    		writeOnce : 'initOnly'
    	},
    	...
    	resources : {
    		...
    		value : {
    			baseUri : 'http://localhost:8080/LHA/data',
    ...
    Y.extend(LHARepository, Y.Base, {
        ...
        /**
         * Looks up an object from one of the object caches used by this repository.
         *  
         * @_lookupInCache
         * @private
         * @param cache { YUI3.Cache } The cache from which to retrieve the object.
         * @param key { Object } The key value that identifies the object to retrieve
         * @returns { Object } The cached object or <tt>null</tt> if no object was registered 
        ...
        /**
         * Called by <tt>getAuthor()</tt> iff we need to execute a request against the server.
         * 
         * @param id { Number } The id of the author to retrieve
         * @param callback { Function } A callback function to be invoked with the response.
        ...
        /**
         * Retrieves the indicated author from the server (using a local cache, if available) 
         * or instantiates it from supplied JSON data. 
         * 
         * @method getAuthor
         * @public
         * @param who { Number | Object } The id of the <tt>Author</tt> to lookup from the 
         * 		server or else an object literal (or unparsed JSON string) to instantiate.  
         * @param callback { Function } A callback function. On success, this method will be 
         * 		called with a single parameter, the retrieved <tt>Author</tt>. On failure, 
         * 		this will be called with two parameters: the first the boolean value 
         * 		<tt>false</tt>, the second an error message detailing what went wrong. 
         * @param force { boolean } If <tt>true</tt> forces retrieval of the identified author 
         * 		from the server even if the author object has been cached or a JSON object 
         * 		is provided. <tt>false</tt> by default.
         * @return The <tt>Author</tt> if a JSON object is supplied or if the identified 
         * 		<tt>Author</tt> is present in an internal cache. Otherwise, <tt>null</tt>.
         */
